...
def test_deserialize_array_int():
    ...
    deserialized = deserializer2(serialized, 'Span<u32>')
    ...
    deserialized = deserializer2(serialized, 'Span<i32>')
...
def test_deserialize_arr_fixed_point():
    ...
    deserialized = deserializer2(serialized, 'Span<FP16x16>')
...
def test_deserialize_tensor_int():
    ...
    deserialized = deserializer2(serialized, 'Tensor<i32>')
